...
export function TimeRangePicker({
  ...
  const getDisplayContent = () => {
    if (rangeType === "custom") {
        ...
        <div className="flex items-center gap-2">
          ...
          <span>
            {dateRange
              ...
              : t("datePicker.selectFromCalendar")}
          </span>
        </div>
      );
      ...
      const messageKey = namedRangeValue
        ? getTimeRangeMessageKey(namedRangeValue)
        : null;
      return (
        <div className="flex items-center gap-2">
          ...
          <span>
            {messageKey ? t(messageKey) : setting?.label || namedRangeValue}
          </span>
        </div>
      );
    } else {
      ...
      return (
        <div className="flex items-center gap-2">
          <CalendarIcon className="h-4 w-4" />
          <span>{t("datePicker.selectTimeRange")}</span>
        </div>
      );
    }
  };
          ...
          {tab === "calendar" ? (
            ...
            <div className="p-1">
              {timeRangePresets.map((presetKey) => {
                ...
                const messageKey = getTimeRangeMessageKey(presetKey);
                return (
                  <div
                    key={presetKey}
                  ...
                  >
                    ...
                    <span>{messageKey ? t(messageKey) : setting.label}</span>
                  </div>
                );
              })}
              <div
              ...
              >
                ...
                <span>{t("datePicker.selectFromCalendar")}</span>
              </div>
            </div>
          )}
        </PopoverContent>
