...
export default function ScoresTable({
  ...
  const scoresFilterConfig = useMemo(
    () => getScoreFilterConfig(hiddenColumns, t),
    [hiddenColumns, t],
  );
  ...
  const rawColumns: LangfuseColumnDef<ScoresTableRow>[] = [
    selectActionColumn,
    {
      ...
      header: t("observability.columns.scoreId"),
      size: 100,
      enableSorting: false,
      defaultHidden: true,
      enableHiding: true,
    ...
    },
    {
      ...
      header: t("observability.columns.trace"),
      enableSorting: true,
      size: 100,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      id: "executionTraceId",
      header: t("observability.columns.executionTrace"),
      enableSorting: false,
      enableHiding: true,
      defaultHidden: true,
      size: 100,
    ...
    },
    {
      ...
      id: "observationId",
      header: t("observability.columns.observation"),
      enableSorting: true,
      size: 100,
      cell: ({ row }) => {
    ...
    {
      accessorKey: "source",
      header: t("observability.columns.source"),
      id: "source",
      enableHiding: true,
      enableSorting: true,
      size: 100,
    ...
    },
    {
      ...
      header: t("observability.columns.dataType"),
      id: "dataType",
      enableHiding: true,
      enableSorting: true,
      size: 100,
    ...
    {
      accessorKey: "value",
      header: t("observability.columns.value"),
      id: "value",
      enableHiding: true,
      enableSorting: true,
      size: 100,
    },
    {
      ...
      headerTooltip: {
        description: t("observability.scores.tooltip.metadata"),
    ...
    {
      accessorKey: "comment",
      header: t("observability.columns.comment"),
      id: "comment",
      enableHiding: true,
      size: 400,
      loadingCell: () => (
    ...
    },
    {
      accessorKey: "author",
      id: "author",
      header: t("observability.columns.author"),
      enableHiding: true,
      size: 150,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: t("observability.columns.evalConfigurationId"),
      id: "jobConfigurationId",
      headerTooltip: {
        description: t("observability.scores.tooltip.evalConfigurationId"),
      ...
      ? [
          {
            ...
            label: t("scores.deleteScores"),
            description: t("scores.deleteScoresDescription"),
            accessCheck: {
              scope: "traces:delete",
            ...
            <DataTable
              ...
              noResultsMessage={
                <div className="flex flex-col items-center">
                  <span>{t("scores.noScoresFound")}</span>
                  <a
