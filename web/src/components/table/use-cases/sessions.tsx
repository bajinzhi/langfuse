...
export default function SessionsTable({
  ...
  const sessionsFilterConfig = useMemo(
    () => getSessionFilterConfig(omittedFilter, t),
    [omittedFilter, t],
  );
  ...
  const addToQueueMutation = api.annotationQueueItems.createMany.useMutation({
    onSuccess: (data) => {
      ...
      showSuccessToast({
        title: t("observability.sessions.toast.queue.title"),
        description: t("observability.sessions.toast.queue.description", {
          queueName,
        }),
        link: {
          href: `/project/${projectId}/annotation-queues/${data.queueId}`,
          text: t("observability.sessions.toast.queue.link", {
            queueName,
          }),
        },
      });
  ...
  const tableActions: TableAction[] = [
    {
      ...
      description: t("observability.sessions.actions.addQueue.description"),
  ...
  const columns: LangfuseColumnDef<SessionTableRow>[] = [
...

    {
      accessorKey: "id",
      id: "id",
      header: t("observability.columns.id"),
      size: 200,
      isFixedPosition: true,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      id: "createdAt",
      header: t("observability.columns.createdAt"),
      size: 150,
      enableHiding: true,
      enableSorting: true,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      id: "sessionDuration",
      header: t("observability.columns.duration"),
      size: 130,
      enableHiding: true,
    ...
    },
    {
      ...
      id: "userIds",
      header: t("observability.columns.userIds"),
      size: 200,
      enableHiding: true,
      loadingCell: <TableTextLoadingCell />,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      id: "countTraces",
      header: t("observability.columns.traces"),
      size: 100,
      headerTooltip: {
        description: t("observability.sessions.tooltip.traces"),
      },
      enableHiding: true,
      enableSorting: true,
      loadingCell: <TableTextLoadingCell />,
