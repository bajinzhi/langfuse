    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span
          ...
          title={
            !column.enableHiding
              ? t("table.columns.notHideableTitle")
              : isFixedPosition
                ? t("table.columns.fixedTitle")
                : undefined
          }
        >
      ...
      {isOrderable && !isFixedPosition && (
        <Button
          ...
          variant="ghost"
          size="xs"
          title={t("table.columns.dragTitle")}
    ...
    >
      <Drawer modal={false}>
        <DrawerTrigger asChild>
          <Button variant="outline" title={t("table.columns.showHide")}>
            <span>{t("table.columns.button")}</span>
          ...
          <div className="mx-auto w-full overflow-y-auto md:max-h-full">
            <div className="sticky top-0 z-10">
              <DrawerHeader className="bg-background flex flex-row items-center justify-between rounded-sm px-3 py-2">
                <DrawerTitle>{t("table.columns.title")}</DrawerTitle>
                <div className="flex flex-row gap-2">
                  ...
                  >
                    {t("table.columns.restoreDefaults")}
                  </Button>
                  <DrawerClose asChild>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  >
                    <span className="text-sm font-medium">
                      {count === total
                        ? t("table.columns.deselectAllColumns")
                        : t("table.columns.selectAllColumns")}
                    </span>
                    <div className="bg-input ml-1 rounded-sm px-1 text-xs">{`${count}/${total}`}</div>
                  </Button>
                </div>
