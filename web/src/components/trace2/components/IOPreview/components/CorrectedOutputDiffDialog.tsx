  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent size="xl">
        <DialogHeader>
          <DialogTitle>{t("trace.corrections.diffTitle")}</DialogTitle>
          <DialogDescription>
            {t("trace.corrections.diffDescription")}
          </DialogDescription>
        </DialogHeader>
          ...
          {hasNoOriginalOutput ? (
            <div className="flex flex-col items-center justify-center p-8 text-center">
              <div className="text-muted-foreground">
                <p className="text-lg font-medium">
                  {t("trace.corrections.noOriginalOutput")}
                </p>
                <p className="mt-2 text-sm">
                  {t("trace.corrections.noOriginalOutputDescription")}
                </p>
              </div>
            </div>
          ) : (
            <div className="space-y-4">
              <DiffViewer
                ...
                oldLabel={t("trace.corrections.originalOutput")}
                newLabel={t("trace.corrections.correctedOutput")}
              />
            </div>
          )}
        </DialogBody>
