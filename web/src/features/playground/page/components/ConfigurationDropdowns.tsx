    ...
    <div ref={containerRef} className="bg-muted/25 shrink-0 border-b px-3 py-2">
      <div className="flex items-center justify-start gap-2">
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button variant="outline" size="sm" className="h-8 gap-2">
              {getResponsiveContent(t("playground.tools"), Wrench)}
              {toolsCount > 0 && (
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button variant="outline" size="sm" className="h-8 gap-2">
              {getResponsiveContent(t("playground.schema"), Braces)}
              {hasSchema > 0 && (
                <Badge variant="secondary" className="h-4 text-xs">
                  {hasSchema}
                </Badge>
          ...
          <PopoverContent className="w-80 p-4" align="start">
            <div className="mb-3">
              ...
              <p className="text-muted-foreground text-xs">
                {t("playground.structuredOutputDescription")}
              </p>
            </div>
            {structuredOutputSchema ? (
              <div className="mb-3">
              ...
              <div className="mb-3">
                <p className="text-muted-foreground text-xs">
                  {t("playground.popover.noSchemaProvided")}
                </p>
              </div>
            )}
            <div className="border-t pt-3">
        ...
        <Popover>
          ...
          <PopoverContent className="w-80 p-4" align="start">
            <div className="mb-3">
              <h4 className="mb-1 text-sm font-medium">
                {t("playground.variablesAndPlaceholders")}
              </h4>
              <p className="text-muted-foreground text-xs">
