              ...
              <DialogBody>
                ...
                {!hasOnlySingleProjectAccess && (
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t("rbac.organizationRole")}</FormLabel>
                        <Select
                        ...
                        >
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue
                                placeholder={t("rbac.selectOrganizationRole")}
                              />
                            </SelectTrigger>
                          </FormControl>
                          <SelectContent>
                      ...
                      <FormItem>
                        ...
                        >
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue
                                placeholder={t("rbac.selectProjectRole")}
                              />
                            </SelectTrigger>
                          </FormControl>
                          <SelectContent>
