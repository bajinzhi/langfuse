...
export function PricingSection({
    ...
    return (
      <div className="space-y-4">
        <div>
          ...
          <FormDescription>
            {t("models.tiers.pricesDescription")}
          </FormDescription>
        </div>
        ...
        <Button type="button" variant="ghost" onClick={addTier}>
          ...
          {t("models.tiers.addCustomPricingTier")}
        </Button>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      <div>
        <FormLabel>{t("models.tiers.pricingTiers")}</FormLabel>
        <FormDescription>
          {t("models.tiers.pricingTiersDescription")}
        </FormDescription>
      </div>
