      ...
      cell: ({ row }) => {
        ...
        return trace.observationId ? (
          <TableLink
            ...
            value={t("datasets.traceObservationLabel", {
              traceId: trace.traceId,
              observationId: trace.observationId,
            })}
          ...
          <TableLink
            ...
            value={t("datasets.traceLabel", { id: trace.traceId })}
            icon={<ListTree className="h-4 w-4" />}
          />
        );
      },
