...
export const ExperimentGridCell = ({
  ...
  const cellRows: CellRowDef<GridCellData>[] = useMemo(
    () => [
      ...
      {
        accessorKey: "output",
        header: t("experiments.grid.output"),
        cell: ({ data }) => (
          <MemoizedIOTableCell
      ...
      // Observation scores
      {
        ...
        header: t("experiments.grid.scores"),
      ...
      // Trace scores
      {
        ...
        header: t("experiments.grid.traceScores"),
      ...
      // Metadata group - itemId, observationId, level, startTime
      {
        ...
        header: t("experiments.grid.metadata"),
        children: [
          {
            accessorKey: "itemId",
            cell: ({ data }) => (
              <MetadataItem label={t("experiments.grid.itemId")}>
          ...
          },
          {
            ...
            cell: ({ data }) => (
              <MetadataItem label={t("experiments.grid.observation")}>
          ...
          },
          {
            accessorKey: "level",
            cell: ({ data }) => (
              <MetadataItem label={t("experiments.grid.level")}>
          ...
          },
          {
            ...
            cell: ({ data }) => (
              <MetadataItem label={t("experiments.grid.startTime")}>
          ...
          },
          {
            ...
            cell: ({ data }) =>
              data.latencyMs != null ? (
                <MetadataItem label={t("experiments.grid.latency")}>
                  <span className="text-xs">
