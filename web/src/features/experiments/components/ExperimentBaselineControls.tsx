    ...
    <div className="flex items-center gap-2">
      <div className="w-full">
        <Combobox
          ...
          placeholder={baselineName ?? baselineId ?? t("experiments.selectBaseline")}
          emptyText={t("experiments.noExperimentsFound")}
          searchPlaceholder={t("experiments.searchExperiments")}
          disabled={isLoading}
          className="h-9"
        />
      </div>
      ...
      {baselineId && canClearBaseline && (
        <Button
          ...
          disabled={isLoading}
          title={t("experiments.clearBaseline")}
        >
          <X className="h-4 w-4" />
        </Button>
      )}
