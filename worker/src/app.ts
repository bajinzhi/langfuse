...
import { promptfooExperimentCreateQueueProcessor } from "./queues/promptfooExperimentQueue";
...
if (
  env.QUEUE_CONSUMER_PROMPTFOO_EXPERIMENT_CREATE_QUEUE_IS_ENABLED === "true"
) {
  WorkerManager.register(
    QueueName.PromptfooExperimentCreate,
    promptfooExperimentCreateQueueProcessor,
    {
      concurrency: env.LANGFUSE_PROMPTFOO_CREATOR_WORKER_CONCURRENCY,
    },
  );
}
